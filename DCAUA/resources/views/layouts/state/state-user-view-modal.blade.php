<div class="modal fade" id="state_user_view_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body modal-body_1">
                <div class="row d-flex justify-content-around fs-6 " id="state_user_view_div">
