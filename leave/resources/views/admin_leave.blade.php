...
<body>
    ...
    @include('section',['class_name'=>'section_1','head_name'=>'Leave Approval Section','number'=>'wait','icon'=>'fa fa-check','link'=>'admin_leave'])
    @include('section',['class_name'=>'section_2','head_name'=>'Leave Approved Section','number'=>'wait','icon'=>'fa fa-thumbs-up','link'=>'leave_approved'])
    @include('section',['class_name'=>'section_3','head_name'=>'Leave Rejected Section','number'=>'wait','icon'=>'fa fa-window-close','link'=>'leave_rejected'])
    </div>
    ...
    @include('layout.modal_1', ['action' => 'show']);
