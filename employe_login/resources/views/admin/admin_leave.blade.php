...
<link href="https://fonts.googleapis.com/css2?family=Noto+Sans&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('css/admin_class.css') }}">
    <link rel="stylesheet" href="{{ asset('css/admin_leave.css') }}">
    <link rel="stylesheet" href="{{ asset('css/section.css') }}">
    <meta http-equiv=”Permissions-Policy” content=”interest-cohort=()”>
    <title>Admin Leave Approval System</title>
    <style>
...
<body>
    ...
    @include('admin.section',['class_name'=>'section_1','head_name'=>'Leave Approval Section','number'=>'wait','icon'=>'fa fa-check','link'=>'admin_leave'])
    @include('admin.section',['class_name'=>'section_2','head_name'=>'Leave Approved Section','number'=>'wait','icon'=>'fa fa-thumbs-up','link'=>'leave_approved'])
    @include('admin.section',['class_name'=>'section_3','head_name'=>'Leave Rejected Section','number'=>'wait','icon'=>'fa fa-window-close','link'=>'leave_rejected'])
    </div>
    ...
    <div class="flex_div main_div">
        ...
        @foreach ($leave_data as $data)
            @php
                $i++;
            @endphp
            @include('admin.layout.approval_data',['i'=>$i,'e_id'=>$data->e_id,
    ...
    @include('admin.layout.modal_1', ['action' => 'show']);
    @include('admin.layout.modal_2')
